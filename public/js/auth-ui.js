    ...
    if (data.user) {
      ...
      wrap.innerHTML =
        ...
        '<div class="user-dropdown" id="userDropdown">' +
          ...
          '</div>' +
          '<hr>' +
          '<a href="/profile.html" class="user-dropdown-item"><img class="user-item-icon" src="/assets/icons/usuariosIcon.png" alt=""> Mi perfil</a>' +
          '<a href="/mis-pedidos.html" class="user-dropdown-item"><img class="user-item-icon" src="/assets/icons/pedidosIcon.png" alt=""> Mis pedidos</a>' +
          '<a href="/cart.html" class="user-dropdown-item"><img class="user-item-icon" src="/assets/icons/carrito.png" alt=""> Mi carrito</a>' +
          '<button class="user-dropdown-item logout-item" id="logoutBtn"><img class="user-item-icon" src="/assets/icons/cerrarSesionIcon.png" alt=""> Cerrar sesión</button>' +
        '</div>';
      ...
      try {
        ...
        if (adminCheck.ok) {
          ...
          adminLink.innerHTML = '<img class="user-item-icon" src="/assets/icons/dashboardIcon.png" alt=""> Panel Admin';
